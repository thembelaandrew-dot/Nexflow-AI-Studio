...
export default function BoutiqueAgency() {
  return (
    <section className="py-24 relative border-t border-slate-800 bg-gradient-to-b from-nexa-dark-blue to-[#02050c] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
        <SectionReveal3D staggerDelay={0.12}>
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <RevealItem3D className="lg:col-span-5 space-y-6">
              <span className="text-brand-cyanAccent uppercase tracking-widest text-xs font-bold bg-brand-cyanAccent/10 px-4 py-1.5 rounded-full border border-brand-cyanAccent/20">Boutique Agency Model</span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">Small Team. Big Results.</h2>
            ...
            <div className="lg:col-span-7 grid sm:grid-cols-2 gap-6">
              <RevealItem3D>
                <div className="glassmorphism p-6 rounded-xl border border-white/5 hover:border-brand-electricBlue/20 transition-all h-full">
