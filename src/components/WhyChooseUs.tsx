...
export default function WhyChooseUs() {
  ...
  return (
    <section id="why-choose-us" className="py-24 relative border-t border-slate-800 bg-gradient-to-b from-nexa-deep to-nexa-dark-blue overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
        <SectionReveal3D staggerDelay={0.08}>
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-brand-cyanAccent uppercase tracking-widest text-xs font-bold bg-brand-cyanAccent/10 px-4 py-1.5 rounded-full border border-brand-cyanAccent/20">Core Principles</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold mt-3 text-white tracking-tight">Why Choose Nexaflow AI?</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {reasons.map((reason, i) => (
              <RevealItem3D key={i}>
                <div className="glassmorphism p-6 sm:p-8 rounded-2xl border border-white/5 relative group hover:border-brand-electricBlue/30 transition-all duration-300 h-full">
