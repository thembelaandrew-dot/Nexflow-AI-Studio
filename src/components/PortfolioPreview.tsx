      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <SectionReveal3D staggerDelay={0.15}>
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <RevealItem3D className="max-w-2xl">
          ...
          <RevealItem3D>
            <div className="glassmorphism p-6 md:p-10 rounded-[2rem] border border-white/5 hover:border-brand-electricBlue/40 hover:shadow-[0_0_40px_rgba(59,130,246,0.15)] transition-all duration-500 group relative overflow-hidden">
