      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.6 }}
            className="glassmorphism p-8 rounded-3xl border border-brand-electricBlue/30 relative"
          >
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="mt-16 max-w-4xl mx-auto glassmorphism p-8 rounded-2xl border border-slate-700/50"
        >
