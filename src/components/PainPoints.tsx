  ...
  return (
    <section id="solutions" className="py-24 relative overflow-hidden bg-gradient-to-b from-nexa-blue-gray via-[#cbd5e1] to-nexa-light-blue border-t border-slate-800/50">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <SectionReveal3D staggerDelay={0.06}>
          <div className="grid lg:grid-cols-2 gap-16">
            {/* Pain Points */}
            <div>
              <RevealItem3D className="mb-10">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold mt-6 text-slate-900 tracking-tight">What is your business losing without a website?</h2>
              </RevealItem3D>
              
              <div className="space-y-4">
                {painPoints.map((point, i) => (
                  <RevealItem3D key={i}>
                    <div className="flex items-start gap-4 bg-white/70 backdrop-blur-md p-4 rounded-xl border border-red-200 shadow-sm hover:border-red-400 hover:shadow-md transition-all">
            ...
            <div>
              <RevealItem3D className="mb-10">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold mt-6 text-slate-900 tracking-tight">How Nexaflow AI Helps</h2>
              ...
              <div className="space-y-4">
                {benefits.map((benefit, i) => (
                  <RevealItem3D key={i}>
                    <div className="flex items-start gap-4 bg-white/80 backdrop-blur-md p-4 rounded-xl border border-emerald-200 shadow-sm hover:border-emerald-400 hover:shadow-md transition-all">
